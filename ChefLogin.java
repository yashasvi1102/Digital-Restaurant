...
public class ChefLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Id", "Table No", "Dish Name", "Quantity", "Total Amount"
            }
        ) {
        ...
        jTextField6.setText("Confirm New Password");
        ...
        jPanel7.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 220, -1));
        ...
        getContentPane().add(jTabbedPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(-5, 40, 800, 490));
...
String aid=jTextField1.getText();
       ...
       String cnewPass=new String(ch2);
        ...
        crit.add(Restrictions.and(Restrictions.eq("Id", aid),Restrictions.eq("pass",oldPass)));
        ...
        else
        {
         ...
         {
            Chef ref=(Chef)session.get(Chef.class,aid);
            ref.setPass(newPass);
            session.update(ref);
            tx.commit();
